...
```
    ...
    [2K   [90m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[0m [32m645.5/645.5 kB[0m [31m31.0 MB/s[0m eta [36m0:00:00[0m
...
```
    ...
    Found 4 shard file(s) to unpack.

    Opening model-00002-of-00004.safetensors...
      Saved: model.layers.10.input_layernorm.weight.safetensors
      Saved: model.layers.10.mlp.bias.safetensors...

    All layers separated. Generating new model.safetensors.index.json...

    --- SUCCESS ---
    Total separate tensors saved: 266
    Total model size: 15.87 GB
...
```
    ...
    generated_token_ids: [28757, 28716, 8389, 13, 24994, 28747, 1824, 349, 272, 7639]
...
```
    ...
    after warmup alloc/res: 4.67350784 10.913579008
    peak alloc: 5.00127488
    🔥 Peak VRAM Allocated:   4769.59 MB
       Current VRAM Allocated: 4457.00 MB
